...
interface Resumen {
  ...
  inventario: {
    totalCapital: number
    porCategoria: Array<{ categoria: string; unidades: number; totalCapital: number }>
  }
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      {cargando ? (
        ...
        <>
          ...
          {datos.inventario.totalCapital > 0 && (
            <div>
              <h2 style={estiloTituloSeccion}>Inventario valorizado</h2>
              <div style={{
                backgroundColor: "var(--color-card)",
                border: "0.5px solid var(--color-borde)",
              }}>
                ...
                <div style={{
                  ...
                  <p style={{
                    ...
                    {fmt(datos.inventario.totalCapital)}
                  </p>
                </div>
                ...
                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                  <thead>
                    <tr style={{ borderBottom: "0.5px solid var(--color-borde)" }}>
                      {[
                        ...
                        { label: "Unidades en stock", align: "right" },
                        { label: "Capital invertido", align: "right" },
                      ].map(({ label, align }) => (
                        <th key={label} style={{
                          padding: "10px 16px",
                  ...
                  <tbody>
                    {datos.inventario.porCategoria.map((fila) => (
                      <tr key={fila.categoria} style={{ borderBottom: "0.5px solid var(--color-superficie)" }}>
                        <td style={{
                          padding: "11px 16px",
                          fontSize: "13px",
                          fontFamily: "'Cormorant Garamond', serif",
                  ...
                  <tfoot>
                    <tr style={{ borderTop: "0.5px solid var(--color-borde)", backgroundColor: "var(--color-superficie)" }}>
                      ...
                      <td style={{
                        ...
                        {datos.inventario.porCategoria.reduce((s, f) => s + f.unidades, 0)}
                      </td>
                      <td style={{
                        padding: "11px 16px",
                        textAlign: "right",
